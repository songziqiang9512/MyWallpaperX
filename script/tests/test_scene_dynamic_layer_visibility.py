...
class SceneDynamicLayerVisibilityTests(unittest.TestCase):
    def test_dynamic_visibility_and_parent_propagation(self) -> None:
        ...
        self.assertEqual(value["rootRestored"], [1, 2, 3])
        self.assertEqual(value["rootHidden"], [3])
        self.assertEqual(value["childHidden"], [1, 3])
        self.assertEqual(value["ownedStillSuppressed"], [1, 2, 3])
        self.assertEqual(value["userSourceStillSuppressed"], [1, 2, 3])
        self.assertTrue(value["scriptTrueHasSourceAuthority"])
        self.assertFalse(value["scriptFalseHasSourceAuthority"])
        self.assertFalse(value["missingScriptHasSourceAuthority"])
        self.assertFalse(value["userSourceHasSourceAuthority"])
