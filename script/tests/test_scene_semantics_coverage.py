...
class SceneSemanticsCoverageTests(unittest.TestCase):
    ...
    def test_current_scene_state_is_linked_from_authoritative_documents(self) -> None:
        ...
        report_paths = (
            ...
            ".codex/scene-eventfollow-final-fixed13-20260725/report.json",
            ".codex/scene-eventfollow-final-flare-20260725/report.json",
        )
        for path in current_state_documents:
        ...
        self.assertIn("完整 Scene suite 375 项：372 通过、3 跳过", evidence)
