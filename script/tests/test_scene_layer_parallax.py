...
SOURCE = REPOSITORY_ROOT / "MyWallpaperX/Core/SteamWorkshopScene/Systems/Input/SceneLayerParallax.swift"
MATRIX_SOURCE = REPOSITORY_ROOT / "MyWallpaperX/Core/SteamWorkshopScene/Rendering/Geometry/SceneMatrix.swift"
...
class SceneLayerParallaxTests(unittest.TestCase):
    ...
    def test_authored_depth_resolution_and_offsets(self) -> None:
        ...
        # NDC right/down -> render-world left/up. Rendering flips world Y,
        # so the resulting screen displacement opposes both pointer axes.
