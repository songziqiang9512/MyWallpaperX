...
SWIFT_SOURCES = [
    ...
    SCENE_ROOT / "RenderGraph/GraphTargets/SceneGraphRenderTargetFormat.swift",
    ...
    SCENE_ROOT / "RenderGraph/GraphTargets/SceneGraphRenderTargetTable.swift",
    SCENE_ROOT / "RenderGraph/GraphTargets/SceneGraphRenderTargetTable+Mapped.swift",
    SCENE_ROOT / "RenderGraph/GraphTargets/SceneGraphRenderTargetLease.swift",
    SCENE_ROOT / "RenderGraph/GraphTargets/SceneGraphRenderTargetLease+Publication.swift",
