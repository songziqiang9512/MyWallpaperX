...
- 这只迁移 Program-compatible Tint 子集；旧 Tint planner/pipeline/renderer 仍服务 mixed/unmigrated fallback，Transform、Film Grain、其他 ordinary family、R4-3、R4-4 与 R4-5 仍待后续波次。44/45、非黑输出、相同 owner 集合与 preview 指标都不证明 Windows 色彩/像素或 Wallpaper Engine 视觉等价；R4-2/R4 未完成，R5 未准入。
