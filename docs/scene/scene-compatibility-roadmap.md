...
> 启动日期：2026-08-15
>
> 当前主线：V1-A correctness 已按专项表闭合；正在清零 V1-B 产品 owner 债务。最新 Pulse optional-opacity-mask alpha-only straight-RGB/scalar-alpha owner cohort 未改变阶段门，V1-B 完成前仍不进入 V2
>
