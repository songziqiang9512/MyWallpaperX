...
| Exact native property-script profiles | D0 + D4 + D7 + D8 + D9 | audio bars两profile仍为bounded native `L3`；Text七个fixed profile已在B18退役，不再按source identity建立产品binding，B18前报告只作历史 |
