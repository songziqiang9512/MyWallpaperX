...
`2938612768:79/165/454` 与 `2974757317:454/2130` 当前命中上述公共placeholder-fade结构并完成Program/GPU/compositor；同两样本的反向fade `626/629/924/2094`、metadata/angle/shared-state及其他媒体脚本仍拒绝。`2902406982:[365,372,647,664]` 的direct binding是另一条独立正门。粗粒度总表中的“Script presence L1”只表示发现能力；bounded fade证据见 [E-MEDIA-PLAYBACK-PLACEHOLDER-FADE](runtime-evidence-index.md#e-media-playback-placeholder-fade)，bounded Text AST与已退役fixed profile的历史边界见 [E-TEXT-SCRIPT](runtime-evidence-index.md#e-text-script)。
