...
| `D` | [`SceneDynamicSnapshot.swift`](../../../MyWallpaperX/Core/SteamWorkshopScene/Properties/SceneDynamicSnapshot.swift)、[`SceneQuickJS.c`](../../../MyWallpaperX/Core/SteamWorkshopScene/Runtime/SceneScript/SceneQuickJS.c)、[`SceneScriptDynamicLayerRuntime.swift`](../../../MyWallpaperX/Core/SteamWorkshopScene/Runtime/SceneScript/SceneScriptDynamicLayerRuntime.swift)、[`SceneScriptDynamicImageReferenceAnalysis.swift`](../../../MyWallpaperX/Core/SteamWorkshopScene/Runtime/SceneScript/SceneScriptDynamicImageReferenceAnalysis.swift)、[`SceneScriptVectorRuntime.swift`](../../../MyWallpaperX/Core/SteamWorkshopScene/Runtime/SceneScript/SceneScriptVectorRuntime.swift) | typed target、固定优先级、真实ECMAScript scalar/Bool/String/Vec2/Vec3 owner、immutable inputs、typed handles/events/timer/jobs、dynamic text与安全package-literal image mutation、exact-once teardown；旧native产品族已删除 | Vec2完整方法、Vec4/matrix、其他module/API handle、async module、任意asset handle/model config、multi-surface lifecycle与官方parity |
