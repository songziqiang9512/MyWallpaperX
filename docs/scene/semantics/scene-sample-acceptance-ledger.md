...
| 首断点集群 | 含义 | 样本数 |
|---|---|---:|
| `effect-chain` | effect 准入 / 颜色合同 / graph 执行 | 25 |
| `particle-load` | 粒子层资源加载 | 9 |
| `texture-load` | 基础图片纹理加载 | 3 |
| `scenescript` | SceneScript 异常 | 5 |
| `visual-review` | 结构链完整，待视觉验收 | 117 |
| `not-run` | 尚无隔离运行证据 | 0 |
...
| `blocked` | 5 |
| `degraded-runtime` | 37 |
| `structural-chain-complete-visual-review` | 117 |
...
| `2775915974` | R18*JK(escalator)エスカレーターJKさんX-ray | 4(0) bool 1 color 1 combo 1 slider 1 | `degraded-runtime` | `effect-admission / EffectStageAdmission / unified-capability-unavailable / backend:effect-family:shake` | `effect-chain` | `fail` 2026-09-08 | 鼠标纵向与顶部边界已修，顶部极限仍露灰边；整样本未通过 |
...
| `2824109832` | Yor Forger - NIXEU 4K | 16(7) bool 12 color 4 | `blocked` | `effect-admission / EffectStageAdmission / unified-capability-unavailable / backend:effect-family:pulse_` | `effect-chain` | `unreviewed` |  |
...
| `2902406982` | 麻匪 月半与鬼哭 所有元素自定义 | 173(103) bool 20 color 45 combo 8 scenetexture 2 slider 35 … | `degraded-runtime` | `effect-execution / ResolvedMaterialExecution / effect-local-passthrough-material-finalizer-dynamic-uniform-binding / resolved-material-graph` | `effect-chain` | `unreviewed` |  |
...
| `2959875782` | [R18] Lexaiduer Last Origin Dark Elven … | 4(0) color 1 combo 2 slider 1 | `degraded-runtime` | `effect-admission / EffectStageAdmission / unified-capability-unavailable / backend:effect-family:blend` | `effect-chain` | `unreviewed` |  |
...
| `3122339805` | Pixels | 39(0) bool 9 color 6 combo 1 scenetexture 3 slider 1 text 7… | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
...
| `3233141951` | 熠烛 御剑驭龙-红鸾樱落 高度自定义Red Warbler-Sakura fa… | 67(0) bool 18 color 7 combo 3 group 1 scenetexture 1 slider… | `degraded-runtime` | `effect-admission / EffectStageAdmission / unified-capability-unavailable / backend:effect-family:opacity` | `effect-chain` | `unreviewed` |  |
...
| `3287715210` | 发光少女 4K动态壁纸 | 17(1) bool 1 color 1 group 1 slider 14 | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `fail` 2026-09-08 | 音频条已恢复（PCM fixture），真实系统音频与整体未验收 |
...
| `3395777145` | 麻匪 光 音频识别 Media Player 16:9 16:10 21:9 | 74(26) bool 14 color 10 combo 5 scenetexture 1 slider 11 te… | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `unreviewed` |  |
...
| `3448845950` | 麻匪 媒体音频标签【148项自定义】Media Player 16:9 16:… | 152(35) bool 22 color 17 combo 14 scenetexture 2 slider 20 … | `blocked` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `fail` 2026-09-08 | 黑屏已解除，脚本效果与整体布局未通过 |
...
| `3477054430` | Cat with headphones on the roof | 25(0) bool 4 color 6 group 6 slider 9 | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `fail` 2026-09-08 | 画面显示不全；mask 已恢复，月亮/球体与文字布局仍开放 |
| `3487629864` | 云曦老婆 (18+) | 仅 schemecolor | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3509243656` | 三体实时演算 \| Three-Body problem - SYKM | 233(2) bool 27 color 20 combo 3 group 21 scenetexture 1 sli… | `degraded-runtime` | `script-execution / SceneScriptVM / scene-script-exception-type-error / target:text:content` | `scenescript` | `fail` 2026-09-08 | 开场/模拟画面不正常，坐标文字异常 |
...
| `3585875739` | Miku Monitoring | 6(0) bool 5 color 1 | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3601964477` | 千咲 \|\| 鸣潮  \|\| 枫 \|\| 4K | 44(19) bool 19 color 5 group 3 slider 7 text 10 | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `unreviewed` |  |
| `3609108600` | 千咲 \|\| 鸣潮 \|\| 4K | 9(4) bool 4 color 1 slider 4 | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3610154602` | 千咲 \|\| 鸣潮 \|\| 高塔 \|\| 4K | 42(16) bool 15 color 4 group 4 slider 6 text 10 textinput 3 | `degraded-runtime` | `script-execution / SceneScriptVM / scene-script-exception-range-error / target:layer:alpha` | `scenescript` | `unreviewed` |  |
| `3612199597` | 千咲 \|\| 鸣潮 \|\| 与千咲的穗波散步 \|\| 咖啡厅天台 \|\… | 40(17) bool 19 color 4 group 3 slider 5 text 9 | `degraded-runtime` | `script-execution / SceneScriptVM / scene-script-exception-range-error / target:layer:alpha` | `scenescript` | `unreviewed` |  |
| `3612795410` | 千咲 \|\| 鸣潮 \|\| 与千咲的穗波散步 \|\| 喷泉广场 \|\|… | 35(15) bool 16 color 4 group 2 slider 3 text 10 | `degraded-runtime` | `script-execution / SceneScriptVM / scene-script-exception-range-error / target:layer:alpha` | `scenescript` | `unreviewed` |  |
...
| `3662790108` | 实时太阳系 Live Solar System - SYKM | 198(26) bool 71 color 9 combo 3 group 12 scenetexture 24 sl… | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `fail` 2026-09-08 | 轨道/布局已恢复，球体与曲率画面、点击交互未验收；约 8.8 FPS |
...
| `3743305891` | 战双 | 仅 schemecolor | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
...
| `3768020435` | Silver Wolf with media integration | 仅 schemecolor | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `unreviewed` |  |
...
| `3775355045` | 交错战线_DAIBLOS CORE_x-ray_4K_1 | 2(0) color 1 slider 1 | `blocked` | `graph-execution / GraphExecutor / graph-execution-missing / resolved-material-graph` | `effect-chain` | `unreviewed` |  |
| `3775373546` | 交错战线_DAIBLOS CORE_x-ray_4K_2 | 2(0) color 1 slider 1 | `blocked` | `graph-execution / GraphExecutor / graph-execution-missing / resolved-material-graph` | `effect-chain` | `unreviewed` |  |
| `3777761326` | I do Anything | 3(0) bool 2 color 1 | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3779026256` | [魔法少女的魔女审判] 月代雪 X 樱羽艾玛 音频识别 | 13(0) bool 4 color 1 group 2 slider 6 | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
...
| `3780940857` | 枕澜 蒂法 电脑动态壁纸 最终幻想7 TIFA Final Fantasy V… | 仅 schemecolor | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3781307553` | Look this | 仅 schemecolor | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
| `3782740481` | WLOP Violet 紫 | 9(0) bool 2 color 2 slider 5 | `degraded-runtime` | `effect-admission / EffectStageAdmission / admitted-fallback / effect-local-passthrough` | `effect-chain` | `unreviewed` |  |
...
| `3788066613` | [Hajily-1825][R-18]2025-07-04 Fleurdely… | 25(0) bool 6 color 4 group 4 slider 10 textinput 1 | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
...
| `3789316755` | Fern_Frieren | 仅 schemecolor | `structural-chain-complete-visual-review` | - | `visual-review` | `unreviewed` |  |
...
| `3792249095` | Beth's Wallpaper | 仅 schemecolor | `degraded-runtime` | `effect-admission / EffectStageAdmission / unified-capability-unavailable / backend:effect-family:crt_scan_line` | `effect-chain` | `unreviewed` |  |
