...
| effect visibility actionable subset | 22 authored rebuild口径 + 2 authored FBO live/owner targets + 1 controlled pair-leaf live target + 5 authored startup-false safe admissions（2 Program-backed / 3 inactive-only） | 20条旧白名单与2条Local Contrast继续按既有重建口径生效；controlled `9000000131:69#effect#131`在already-admitted pair leaf内消费exact bool。真实`3211615441:24#effect#613`与`26#effect#257`在已准入安全FBO graph内live切换，并已由validated target-local direct-bool view、ordinary-root gate及完整KERNEL0 proof完成bounded `generic-only` owner迁移；默认/恢复均0 dedicated，profile-local disable只回到shared effect-local previous-current且不复活dedicated。真实`3767460992`的5个startup-false安全leaf进入共享graph，其中Film Grain `17#effect#725`已由`sparklyonoff=true`在同一surface/window激活普通Program，另3项无Program只持有graph passthrough member且不形成CPU exact owner。[E-PROPERTY](runtime-evidence-index.md#e-property) [E-V1-XRAY-SHARED-STAGE-ACTIVATION-OWNER](runtime-evidence-index.md#e-v1-xray-shared-stage-activation-owner) [E-V1-FBO-STAGE-ACTIVATION](runtime-evidence-index.md#e-v1-fbo-stage-activation) [E-V1-STANDARD-BLUR-DIRECT-BOOL-VISIBILITY-OWNER](runtime-evidence-index.md#e-v1-standard-blur-direct-bool-visibility-owner) [E-V1-STARTUP-FALSE-EFFECT-VISIBILITY](runtime-evidence-index.md#e-v1-startup-false-effect-visibility) | `L3 bounded / exact two-target owner-migration` | controlled target不计corpus；5项startup admission不等于5项live consumer，且不刷新129项全census。candidate撤权由当前compiler guard与可执行partition门而非runtime preview计数证明；startup-false FBO/target/dependency/command、Timeline/SceneScript、persistent/unique、condition/function/compose与完整authored consumer census仍缺 |
