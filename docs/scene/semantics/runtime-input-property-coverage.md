...
| shader constant actionable subset | 20 + 4 bounded | census的19条旧白名单经重建进入受限executor；Local Contrast strength现由共享Program live消费snapshot，`2902406982:[365,372,647,664]` stock Opacity alpha继续由其现役bounded consumer读取；[E-LIVE-PROPERTY](runtime-evidence-index.md#e-live-property) | `L3` | 其他generic executor、SceneScript与通用live uniform |
