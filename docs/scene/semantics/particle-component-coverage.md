...
> 粒子落地提交分别是 eventspawn/death `f4173ea`/`7d53c10`、eventfollow `928acca`、持续 child/root aggregate budget `2f897bc`、static/default-static `899704b`、有限 static origin `678a052`、strict depth-two nested child/per-depth 预算 `b86db59`、非音频 turbulent velocity `4a17ee6`、strict REFRACT `e698c18`、REFRACT BC3 purpose `8b06538d`、static world-space `54a6ebc`、非音频 Turbulence operator `7b1d36f`、TEX sampler `d19e76b`、分布/offset/lifetime Alpha/Size oscillation `d792296`、实际 mip 链 `f4e8a0c`、lifetime-normalized Position oscillation `5911049`、strict RopeTrail `aa68bb8`、bounded Random periodic `69731707`、bounded raw parent Control Point copy `40768dfc`、bounded emitter Control Point identity `c6fc9c24`、bounded emitter speed `938630a0`、bounded emitter shape `ce16de08`、bounded pointer Control Point Force `482ed21a`、bounded basic Rope `9a098351`、bounded Rope subdivision/UV/strict-child `319214c5` 与 Sprite Trail omitted-length `36b9775a`。最近完整 45 样本门仍是 `f161de8a` 的 particle `129/130`，唯一 root 缺口为显式空 renderer；它早于后两批粒子提交，不能作为两批正门。本批另跑真实 `3770444459`、官方 stock `previewwaterimpact`、粒子全套、全 Scene tests 与签名 App，没有重跑 fixed13/full45。仍不是通用 Particle System。
