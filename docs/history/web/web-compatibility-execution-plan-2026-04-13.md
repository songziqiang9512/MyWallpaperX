...
> **历史证据 — 非现役入口**
>
> 本文仅保存 2026-04-13 的分类修复方案；其中“当前”“已支持”、实施顺序、命令和路径均不得驱动现役开发。
>
> 现役能力、所有权、证据和剩余工作只查 [Web 现役状态](../../web/current-state.md)；全部历史材料见[历史索引](../README.md)。

> 状态：历史实施方案，不是当前执行顺序、能力或运行证据入口。文中的“当前”“已支持”和文件路径只描述 2026-04-13 批次；后续工作从 [Web 现役状态](../../web/current-state.md)选择。
